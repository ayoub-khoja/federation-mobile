  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg overflow-hidden mb-6 transition-all duration-300 hover:shadow-xl">
      <div className="p-6">
              ...
              !videoError && (
                <div className="relative">
                  <video
                    ...
                    poster={
                      news.image && isValidImageUrl(news.image)
                        ? news.image
                        : undefined
                    }
          ...
          <div className={`mb-4 ${isRtl ? "text-right" : "text-left"}`}>
            ...
            {content.length > 150 && (
              <button
                ...
                className={`text-red-600 hover:text-red-700 text-sm mt-2 transition-colors font-medium ${
                  isRtl ? "font-sans" : ""
                }`}
              >
                {isExpanded
        ...
        {/* Footer avec date */}
        <div
          className={`flex items-center text-sm text-gray-500 border-t border-gray-200 pt-4 ${
